...
CREATE SEQUENCE if not exists reference_id_seq START WITH 1;
...
(1, 2, 4, '2023-04-10 10:00:48', 'in progress'),
(2, 2, 4, '2023-04-15 15:22:50', 'ready'),
(3, 2, 4, '2023-05-18 17:59:59', 'done');
